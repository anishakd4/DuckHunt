...
public class GameSoundHandler implements Runnable {
    ...
    public static GameSoundHandler getInstance(Context context) {
        if (gameSoundHandler == null) {
            gameSoundHandler = new GameSoundHandler();
            gameSoundHandler.setContext(context);
            gameSoundHandler.getInstance(context).createSoundPool();
            gameSoundHandler.getInstance(context).loadSounds();
    ...
    public void loadSounds() {
        soundMap.put(GameConstants.GUN_SHOT_SOUND,
                soundPool.load(context, GameConstants.GUN_SHOT_SOUND, 1));
        soundMap.put(GameConstants.DUCK_FLAP_SOUND,
                soundPool.load(context, GameConstants.DUCK_FLAP_SOUND, 1));
        soundMap.put(GameConstants.DEAD_DUCK_FALL_SOUND,
                soundPool.load(context, GameConstants.DEAD_DUCK_FALL_SOUND, 1));
        soundMap.put(GameConstants.DEAD_DUCK_LAND_SOUND,
                soundPool.load(context, GameConstants.DEAD_DUCK_LAND_SOUND, 1));
        soundMap.put(GameConstants.STARTING_SEQUENCE_SOUND,
                soundPool.load(context, GameConstants.STARTING_SEQUENCE_SOUND, 1));
        soundMap.put(GameConstants.TITLE_SEQUENCE_SOUND,
                soundPool.load(context, GameConstants.TITLE_SEQUENCE_SOUND, 1));
        soundMap.put(GameConstants.PAUSE_SOUND,
                soundPool.load(context, GameConstants.PAUSE_SOUND, 1));
        soundMap.put(GameConstants.ROUND_CLEAR,
                soundPool.load(context, GameConstants.ROUND_CLEAR, 1));
        soundMap.put(GameConstants.PERFECT_SCORE,
                soundPool.load(context, GameConstants.PERFECT_SCORE, 1));
        ...
        soundMap.put(GameConstants.DOG_BARKING_SOUND,
                soundPool.load(context, GameConstants.DOG_BARKING_SOUND, 1));
    }
