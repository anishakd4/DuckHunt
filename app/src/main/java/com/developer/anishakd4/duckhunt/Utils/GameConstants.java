...
public class GameConstants {
    ...
    public static final String KEY_TOP_SCORE_PREFS = "KEY_DUCK_HUNT_TOP_SCORE_PREFS";
    public static final String KEY_TOP_SCORE = "KEY_DUCK_HUNT_TOP_SCORE";
    ...
    public static final Map<String , Integer> COLOR_TO_SCORE = new HashMap<String, Integer>() {{
        put("green",    500);
        put("red", 1000);
        put("pink",   1500);
    }};
